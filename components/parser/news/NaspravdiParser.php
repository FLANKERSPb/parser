...
/**
 * News parser from site https://naspravdi.info/
 * @author jcshow
 */
class NaspravdiParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://naspravdi.info';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        $imageBlock = $crawler->filterXPath('
            //div[contains(@id,"block-system-main")]
            //div[contains(@class,"field-name-field-news-image")]
            //img[1]
        ')->getNode(0);
