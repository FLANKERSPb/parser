...
/**
 * News parser from site http://mayak-terbuny.ucoz.org/
 * @author jcshow
 */
class MayakTerbunyParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://mayak-terbuny.ucoz.org';
    ...
    public static function getNewsData(): array
    {
        ...
        /** Get RSS news list */
        $curl = Helper::getCurl();
        $newsList = $curl->get(static::SITE_URL . "/publ/rss/");
        if (! $newsList) {
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        $imageBlock = $crawler->filterXPath('
            ...
            //table[contains(@class,"eBlock")]
            //a[contains(@class,"ulightbox")][1]
            //img[1]
        ')->getNode(0);
