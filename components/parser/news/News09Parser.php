...
/**
 * News parser from site http://09-news.ru/
 * @author jcshow
 */
class News09Parser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://09-news.ru';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        //Get image if exists
        $picture = null;
        $imageBlock = $crawler->filterXPath('//div[@id="content"]//img[1]')->getNode(0);
