...
class ProgorodnnParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://progorodnn.ru/';
    public const NEWSLIST_URL = 'https://progorodnn.ru/rss';
