...
class Pg13Parser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://pg13.ru';
    public const NEWSLIST_URL = 'https://pg13.ru/rss';
