...
/**
 * News parser from site http://russkievesti.ru/
 * @author jcshow
 */
class RusskieVestiParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://russkievesti.ru';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        self::removeNodes($crawler, '
            ...
            //div[contains(@class,"articles")]
            //div[contains(@class,"postinfo")]
            //a | //div[contains(@class,"container")]
            //div[contains(@class,"articles")]
            //div[contains(@class,"postinfo")]
            //span | //div[contains(@class,"container")]
            //div[contains(@class,"articles")]
            //div[contains(@class,"postinfo")]
            //b
        ');
        ...
        /** Get item datetime */
        $dateContainer = $crawler->filterXPath('
            //div[contains(@class,"container")]
            //div[contains(@class,"articles")]
            //div[contains(@class,"postinfo")]
        ')->getNode(0);
        $createdAt = new DateTime($dateContainer->textContent . ' ' . date('H:i:s'));
        ...
        if (! empty($imageBlock) === true) {
            ...
            $imageBlock->parentNode->parentNode->removeChild($imageBlock->parentNode);
        }

        /** Get description */
        $detailPage = $crawler->filterXPath('//div[contains(@class,"container")]//div[contains(@class,"articles")]')->getNode(0);
        $description = [];
