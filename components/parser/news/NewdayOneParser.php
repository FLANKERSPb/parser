...
/**
 * News parser from site https://newday.one/
 * @author jcshow
 */
class NewdayOneParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://newday.one';
    ...
    public static function getNewsData(): array
    {
        ...
        /** Get RSS news list */
        $curl = Helper::getCurl();
        $newsList = $curl->get(static::SITE_URL . "/novosti/feed/rss/nd-news.feed");
    ...
    public static function getPostDetail(DOMElement $item)
    {
        ...
        //Get image if exists
        $picture = null;
        $imageBlock = $crawler->filterXPath('//figure[contains(@class, "fullstory-img")]//img')->getNode(0);
        ...
        $detailPage = $crawler->filterXPath('//div[@id="fulltext"]')->getNode(0);
