...
/**
 * News parser from site https://topicru.ru/
 * @author jcshow
 */
class TopicruParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://topicru.ru';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        $descriptionHtml = $itemCrawler->filterXPath('//turbo:content')->getNode(0);
        ...
        if (! empty($imageBlock) === true) {
            ...
            $imageBlock->parentNode->parentNode->parentNode->removeChild($imageBlock->parentNode->parentNode);
        }
