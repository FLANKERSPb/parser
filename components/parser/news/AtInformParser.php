...
/**
 * News parser from site https://atinform.com/
 * @author jcshow
 */
class AtInformParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://atinform.com';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        $imageBlock = $crawler->filterXPath('
            ...
            //td[contains(@class,"eMessage")]
            //a[contains(@class,"ulightbox")]
            //img[1]
        ')->getNode(0);
