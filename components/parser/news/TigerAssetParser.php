...
/**
 * News parser from site http://tiger-asset.com/
 * @author jcshow
 */
class TigerAssetParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://tiger-asset.com';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        self::removeNodes($crawler, '
            ...
            //div[contains(@class,"wp_rp_wrap")]
        ');
        self::removeNodes($crawler, '
            //main[@id="main"]
            //article[contains(@class,"post")]
            //div[contains(@class,"entry-content")]
            //div[contains(@class,"page-links")]
        ');
